...
<main>
            ...
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        ...
                        <div class="page-header-subtitle">Halaman untuk me-manage data bank</div>
                    </div>
    ...
    <div class="container-xl px-4 mt-n10">
        <div class="card">
            <div class="card-header">Master Bank</div>
                <div class="card-body">
            ...
            <div class="modal-body">
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" id="my-form">
                        ...
                        <!-- Form Group (username)-->
                        <div class="mb-3">
                            <label class="small mb-1" for="inputUsername">Bank</label>
