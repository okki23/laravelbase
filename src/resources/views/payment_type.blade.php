...
<main>
            ...
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        ...
                        <div class="page-header-subtitle">Halaman untuk me-manage data payment_type</div>
                    </div>
    ...
    <div class="container-xl px-4 mt-n10">
        <div class="card">
            <div class="card-header">Master Payment Type</div>
                <div class="card-body">
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" id="my-form">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="payment_type_name"  name="payment_type_name" type="text"  >
...
<script>
    ...
    function DeleteData(id){
        if(confirm('Anda yakin ingin menghapus data ini?')){
            $.ajax({
            url : "{{ route('payment_type_destroy') }}",
            type: "POST",
            data: {id:id},
            success: function(data)
            { 
    ...
    function UbahData(id){ 
        $('#myModal').modal('show');  
        $.ajax({
            url : "{{ route('payment_type_get_data') }}",
            type: "POST",
            data: {id:id},
            success: function(data)
            {  
